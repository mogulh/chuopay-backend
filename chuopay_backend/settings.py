"""
Django settings for chuopay_backend project.
"""
...
ROOT_URLCONF = 'chuopay_backend.urls'
...
WSGI_APPLICATION = 'chuopay_backend.wsgi.application'
...
SMS_PROVIDER = config('SMS_PROVIDER', default='twilio')  # twilio or africas_talking
