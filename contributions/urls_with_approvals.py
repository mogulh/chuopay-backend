...
from .approval_views import (
    EventApprovalViewSet,
    ParentApprovalPinViewSet,
    EventDocumentViewSet,
    DocumentSignatureViewSet,
    SchoolLetterheadViewSet
)
...
router.register(r'payment-history', views.PaymentHistoryViewSet)
router.register(r'parent-dashboard', views.ParentDashboardViewSet, basename='parent-dashboard')
router.register(r'reminder-logs', views.ReminderLogViewSet)

# Approval system URLs
router.register(r'approvals', EventApprovalViewSet, basename='approval')
router.register(r'approval-pins', ParentApprovalPinViewSet, basename='approval-pin')
router.register(r'documents', EventDocumentViewSet, basename='document')
router.register(r'document-signatures', DocumentSignatureViewSet, basename='document-signature')
router.register(r'letterheads', SchoolLetterheadViewSet, basename='letterhead')
